...
uint8_t   jpeg_data_buf[JPEG_BUF_SIZE_MAX] __attribute__((at(SDRAM_DEVICE_ADDR+480*272*2))); //the jpeg buffer is set behind the LCD layer1(480*272,RGB565 mode) in the SDRAM
